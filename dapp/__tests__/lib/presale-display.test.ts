...
describe('presale-display', () => {
  it('formatea fecha y hora desde timestamp de contrato', () => {
    ...
    expect(formatPresaleDateLabel(1_779_275_658)).toBe('20 de mayo de 2026 a las 11:14 UTC');
    expect(formatPresaleDateLabel(1_779_275_658, { short: true })).toBe('20 may a las 11:14 UTC');
  });
