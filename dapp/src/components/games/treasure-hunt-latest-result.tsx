  ...
  return (
    <section aria-labelledby="treasure-hunt-latest-result-title" className="overflow-hidden rounded-[8px] border border-[var(--uki-lilac-border)] bg-[#0d0914]/94">
      ...
      <dl className="grid border-t border-[var(--uki-lilac-border)] sm:grid-cols-5 sm:divide-x sm:divide-[var(--uki-lilac-border)]">
        ...
        <div className="px-4 py-3.5"><dt className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-[0.1em] text-[#969994]"><Medal className="h-3.5 w-3.5 text-[var(--uki-lilac)]" /> Clasificación semanal</dt><dd className="mt-1 text-sm font-black text-[var(--uki-cream)]">{weeklyStatus}</dd><p className="mt-0.5 text-[11px] text-[#969994]">{result.creditSource === 'own' ? 'Pagada con saldo personal' : 'Pagada por el pool'}</p></div>
