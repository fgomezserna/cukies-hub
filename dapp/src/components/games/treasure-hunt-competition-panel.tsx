...
export default function TreasureHuntCompetitionPanel() {
  ...
  const canEnterCompetition = phase === 'active';

  return (
    <section
      aria-labelledby="treasure-hunt-competition-title"
      className="relative overflow-hidden rounded-[14px] border border-emerald-300/20 bg-[#0d1916]/95 text-card-foreground shadow-[0_24px_64px_-34px_rgba(3,18,17,0.8)]"
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-0 top-0 h-[20rem] w-[42rem] max-w-[72%] bg-[url('/brand/generated/uki-treasure-hunt-scene-v2.png')] bg-cover bg-center opacity-20 [mask-image:linear-gradient(to_left,black,transparent)]"
      />
      <header className="relative px-5 py-6 sm:px-6 sm:py-7">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-[64ch] text-sm leading-relaxed text-muted-foreground">
              La edición activa de Treasure Hunt: partidas 1P, clasificación propia y
              recompensas referenciadas a los UKI comprados durante la preventa.
            </p>
          </div>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-2">
            {canEnterCompetition ? (
              <Link
                ...
                className="inline-flex min-h-11 items-center gap-2 rounded-[10px] bg-emerald-300 px-4 text-sm font-black text-[#06211b] shadow-[0_12px_28px_-15px_rgba(110,231,183,0.85)] transition hover:bg-emerald-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-200 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0d1916] active:translate-y-px"
              >
              ...
              <button
                type="button"
                disabled
                className="inline-flex min-h-11 cursor-not-allowed items-center gap-2 rounded-[10px] border border-white/10 bg-white/[0.04] px-4 text-sm font-black text-slate-500"
              >
                <span aria-hidden="true">▶</span>
            ...
            <Link
              ...
              className="inline-flex min-h-11 items-center gap-2 rounded-[10px] border border-white/10 bg-black/15 px-4 text-sm font-bold text-slate-200 transition hover:border-emerald-300/25 hover:bg-emerald-300/[0.07] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300/60"
            >
              <span aria-hidden="true">◎</span>
              Ver ranking
            </Link>
            <Link
              ...
              className="inline-flex min-h-11 items-center gap-2 rounded-[10px] px-3 text-sm font-bold text-slate-400 transition hover:text-emerald-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300/60"
            >
              <span aria-hidden="true">▤</span>
              Reglas completas
            </Link>
