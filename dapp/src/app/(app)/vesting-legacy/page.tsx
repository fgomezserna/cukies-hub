...
export default function VestingPage() {
  ...
  return (
      <div className="uki-landing -m-6 min-h-screen px-6 py-8 text-[var(--uki-cream)] md:-m-8 md:px-8">
        ...
        <section className="relative overflow-hidden rounded-[16px] border border-[var(--uki-lilac)]/20 bg-[#070817]/90 p-6 shadow-[0_0_52px_rgba(228,92,255,0.12)] md:p-8">
        ...
        {hasPosition ? (
          <div className="rounded-[12px] border border-[var(--uki-lilac)]/25 bg-[var(--uki-lilac)]/10 px-4 py-3 text-sm font-semibold leading-relaxed text-[var(--uki-text)]">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.35fr_0.85fr]">
          <section className="rounded-[14px] border border-[var(--uki-lilac)]/22 bg-[#070817]/90 p-5 shadow-[0_0_44px_rgba(228,92,255,0.08)]">
