...
const preferredCollections = [
  ...
  'presale_referral_campaign_config',
...
function buildSearchFilter(q: string) {
  ...
  return {
    $or: [
      ...
      { normalizedWalletAddress: pattern },
      { buyerWalletAddress: pattern },
      { buyerWalletNormalized: pattern },
      { sponsorWalletAddress: pattern },
      { sponsorWalletNormalized: pattern },
      { ambassadorWalletNormalized: pattern },
      { referredWalletNormalized: pattern },
      { invitationCode: pattern },
      { referralCode: pattern },
      { pendingSponsorCode: pattern },
