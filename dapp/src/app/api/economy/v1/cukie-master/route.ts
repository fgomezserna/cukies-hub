...
import {
  publicCukieMasterNftIndexerStatus,
  publicCukieMasterRouteStatus,
  visibleCukieMasterNftInventory,
} from '@/lib/uki-economy/cukie-master/public-view';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const publicRoutes = {
      uki: publicCukieMasterRouteStatus(status.routes.uki),
      nft: publicCukieMasterRouteStatus(status.routes.nft),
    };
    ...
    const response = NextResponse.json({
      ...
      data: {
        ...
        nftCustody: {
          ...
          indexer: {
            status: publicCukieMasterNftIndexerStatus(status.routes.nft.sourceCompleteness),
          },
        },
      },
    });
