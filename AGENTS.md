...
- Mantén en paralelo los frentes independientes que puedan delimitarse por archivos o servicios, con hasta cuatro ejecutores por defecto si el runtime lo permite y sin subdelegación. Ajusta la concurrencia a la independencia real y a la capacidad de revisión; no dejes trabajo listo esperando a tareas ajenas. Un único dueño por área compartida; integra y despliega los lotes de uno en uno. Agrupa 2-5 puntos relacionados y no lances un agente por check. Para documentación pequeña, edita localmente sin ceremonia.
