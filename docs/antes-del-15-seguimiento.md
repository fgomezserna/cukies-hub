...
Estado comprobado el **11 de septiembre de 2026, 13:56 UTC**: L1 cerró los
hallazgos de PR425 y espera integración. PR426 está mergeada en main y su
despliegue productivo está en curso. L4 corrige PR427; L3 está activa. L2, L5
y L7 permanecen en cola.
...
El despliegue productivo1534 sigue en curso; no se afirma todavía QA servida
ni resolución completa de estos siete lotes.
...
[PR427](https://github.com/fgomezserna/cukies-hub/pull/427#issuecomment-5635375064)
requiere vincular el plan al runtime real y exigir los hashes completos.
El sondeo productivo de las13:10UTC no reprodujo el503;
...
| --- | --- | --- | --- |
| L1 | M1, M2, P1, O2: custodia entre Master/Pool/Mis Cukies, elegibilidad de Originales y convergencia tras recibo. | [#419](https://github.com/fgomezserna/cukies-hub/issues/419) · **11-Sep · Custodia y actualización de Cukies**, tarea `01a09068-1787-7a20-a4bf-c2c2b28f5586` | [PR425](https://github.com/fgomezserna/cukies-hub/pull/425), `b224c1e`, 270 suites/2269 tests, lint y tipos correctos. Correcciones de locks, identidad y frescura revisadas por raíz. Pendiente merge y QA servida, en cola de despliegue. `codex/doc11-custody-refresh` → `staging`. |
...
| L3 | J2: guardar y volver a leer el alias del perfil con sesión válida. | [#422](https://github.com/fgomezserna/cukies-hub/issues/422) · **11-Sep · Guardado del alias**, tarea `01a09068-a8af-79e0-877d-228e413065a1` | Activada a las13:55UTC sobre staging `b374505`. Escritura de alias separada de lectura pública de L6. `codex/doc11-profile-alias` → `staging`. |
| L4 | J1, W1, W2: reserva del bote, UKI directo y reparto a los prestadores de los recursos usados. | [#418](https://github.com/fgomezserna/cukies-hub/issues/418) · **11-Sep · Recompensas y bote semanal**, tarea `01a09068-e5f9-7a01-838b-82f98da5a5a2` | [PR427](https://github.com/fgomezserna/cukies-hub/pull/427), primera entrega `e6a7320`, 270 suites/2252 tests. Corrección activa: entorno real, hashes completos y validador de caps. Solo prepara recuperación tardía; censo actualizado, apply y asignación real pendientes. `codex/doc11-reward-accrual` → `staging`. |
...
| L6 | A1, A2, A3: invitación válida, relación ya confirmada y nombre público del patrocinador. | [#424](https://github.com/fgomezserna/cukies-hub/issues/424) · **11-Sep · Hotfix de embajadores**, tarea `01a09068-3c90-7ff3-b7a5-16dac47d66c1` | [PR426](https://github.com/fgomezserna/cukies-hub/pull/426) mergeada main `d1a7149`; revisión final `9ba0054`, 173 suites/1501 tests y lint/tipos/build correctos. Deploy1534 en curso. Backport `codex/doc11-ambassadors-staging` conserva tabs de staging; en validación. A1 sigue pendiente del enlace activo. |
