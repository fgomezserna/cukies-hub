...
| J1 | Bote en Jugar | Espera de cada periodo forward desplegada y verificada · PR4408bfa143b · 12-Sep03:57UTC | Comprobar bote y recorrido de una partida nueva. |
...
| W3 | Premios por periodo y cobro | PR437 desplegada; diario publicado con3recibos verificados y primer semanal vacío íntegro y sin duplicados · 12-Sep00:14UTC | Partida nueva, reparto y cobro personal pendientes. |
...
| O1 | Partidas diarias disponibles con Cukies propios elegibles | Implementado y validado; [PR442](https://github.com/fgomezserna/cukies-hub/pull/442) lista para staging | Candidato 1566c24f: 272 suites / 2368 tests, tipos, lint y Mongo real correctos. Consulta de solo lectura con datos de stage: 62 partidas verificadas, 11 Cukies elegibles y 1 pendiente. Falta merge y despliegue. [Evidencia](evidence/2026-09-12-own-cukie-quota.json). |
...
| L7 | O1: total de partidas diarias restantes del conjunto de Cukies propios elegibles, con la misma matriz que el Pool. | [#412](https://github.com/fgomezserna/cukies-hub/issues/412) · **11-Sep · Partidas con Cukies propios**, tarea `01a09069-7cdf-71d1-b03d-5d246eacc44e` | La aclaración del 12-Sep elimina el bloqueo de definición. [PR442](https://github.com/fgomezserna/cukies-hub/pull/442), código final `1566c24f`: contador agregado, renovación por periodo, consumo conservado al transferir o cambiar custodia, fallback Pool/Seiku y ciclos de 1800 s. Consulta independiente de solo lectura contra stage a las 11:57 UTC: al menos 62 partidas de 11 Cukies, 1 pendiente de comprobar; los 6 registros ya excluidos por staking no contaminan el resultado. Gate final: 272 suites / 2368 tests, lint y tipos; 16 tests de esquema/índices y prueba con Mongo real. Índices diarios preparados en una colección nueva y vacía de staging, sin modificar historial. Rama `codex/doc11-own-cukie-quota`; raíz asume merge, despliegue y comprobación servida. [Evidencia](evidence/2026-09-12-own-cukie-quota.json). |
