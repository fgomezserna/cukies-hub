...
| 12-O2 · Otros 2 | Tras staking/retirada UKI o NFT confirmados, mostrar saldo, cupos, créditos y avisos coherentes sin recargar; comprobaciones adicionales en segundo plano. | D12-3 · #421 / #419 | PR453: candidato `ad13fba0` corrige la hidratación Master+Credits y retira expectativas sustituidas/terminales manteniendo identidad, epoch y generación. La tarea termina63 pruebas focales; raíz integra staging actual en `3bcf8c18` y pasa275 suites/2417 tests, tipos y lint. Revisión independiente de cierre en curso; todavía sin merge/deploy. Conserva gracia y créditos ganados. |
...
| D12-3 | **12-Sep · Créditos y actualización de cupos**, tarea `01a095b3-7ec0-7280-8d5f-694bf44a18bc` | `codex/doc12-credit-coherence` → `staging` | PR450 y PR452 ya desplegadas: lectura/cortes/avisos C2 operativos. O2 en PR453, rama `codex/o2-readback-coherence`, worktree `54f6`: candidato `ad13fba0` entregado; integración raíz `3bcf8c18` con275 suites/2417 tests, tipos y lint correctos. Revisión de cierre Astra en curso antes de merge/deploy. |
