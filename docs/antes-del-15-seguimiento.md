...
| D | **MIGRACION LEGACY Y WORLD POR COMPLETAR; DOS LOTES COORDINADOS**: conservar el port World y migrar contratos, datos, identidad y consumidores legacy sobre la infraestructura nueva. Learn/Ludo, auth/GraphQL y operacion Unreal/Agones siguen en el alcance total. | 2026-09-10: [PR346](https://github.com/fgomezserna/cukies-hub/pull/346), `f4cae5e307fed2a84acf0de3e33d0dae9b25b0a1`, worktree limpio y sin commits posteriores; DRAFT/OPEN, sin integrar ni desplegar; requiere adaptación a la infraestructura actual. Traslada world-api/matchmaking/shared con procedencia del origen, 137 tests World y 40 de infraestructura historicos. [PR358](https://github.com/fgomezserna/cukies-hub/pull/358), `1542c25`, integrada en PR366 para navegación/lecturas blockchain Legacy; no acredita paridad completa. | World: tarea `01a085a9-ce55-75e0-831e-b356608c2ab9`, Identifica los dos proyectos; conservar paquetes, infrastructure/world, lock/importers y procedencia historica sin rehacerla desde un origen distinto. Blockchain Legacy: `01a08727-0cdb-7993-bbab-6829bcf3d333`. INFRA posee la edicion de CI/Compose/Docker/Nx/workspaces/lock/manifiestos y acuerda una única ventana de adaptación346 tras el cierre367 y su registro documental; registrar imagenes World, Redis de infraestructura e invalidacion shared hacia ambas imagenes. Reconciliar datos/IDs, emisor Hub→World, cliente y unico escritor antes de activar; cero consumidores antes de retirar servicios antiguos. |
...
| post1-2 | **ANTES DEL 15 · RUTAS Y LECTURAS PARCIALES PUBLICADAS**: Crías y Cukie Points aparecen en la navegación compartida; las escrituras permanecen cerradas. | 2026-09-10: código PR358 integrado en366 y conservado en Stage `11de87e4`. Points BSC muestra total1.205.934, emitidos1.358.198 y quemados152.264. El diagnóstico atribuye TRON429 a cuatro constantes simultáneas contra el límite anónimo de TronGrid; Promise.all descarta éxitos parciales. Crías bloquea candidatos por wallet97, aunque la cabecera0/1 se lee de BSC56 y coincide con consulta directa. [Evidencia del lote y diagnóstico](evidence/2026-09-10-seller-legacy-integration.json). | Responsable Legacy `01a08727-0cdb-7993-bbab-6829bcf3d333` tiene candidato local `17cff24`, proveedor TRON de lectura y resultados parciales/unknown; 26tests focales/lint/tipos/build PASS. La revisión exige corregir todavía Actualizar/preview/empty state de Crías, que siguen dependiendo de la red de firma, y el texto técnico. Una corrección acotada autorizada, conservando todas las barreras de escritura; aún sin publicar. Sin push/deploy concurrente ni cambios de infraestructura. Reconciliar claimed/pending, eventos y cursores e identificar Bread por address/bytecode/ABI; este lote no cierra paridad ni operaciones. |
...
El cierre documental posterior debe reutilizar las seis imágenes y omitir la entrega;
la raíz comprobará ese resultado en la PR, sin otra cadena de commits de evidencia.
La adaptación local de PR346 conserva el candidato `1661ecaa` (205 deltas
inventariados y 200 archivos exactos al origen). INFRA añade su capa local y
conserva propiedad exclusiva de los archivos compartidos. El bloqueo de acceso
al juego diagnosticado después tiene prioridad de entrega DApp-only; World
reconciliará esa base antes de su publicación, sin sobreescribir el parche. Los lotes358/359 no sustituyen el
port World; sus cruces documentales los resuelve la raiz preservando todas las
filas y la evidencia fechada. No se aplica un archivo Compose/lock/seguimiento
antiguo completo ni se resuelven conflictos de forma indiscriminada con
ours/theirs. Registrar imagenes no activa World ni su escritor; el cambio de
trafico requiere las verificaciones operativas de la filaD.
