...
| --- | --- | --- | --- |
| 12-J1 · Jugar 1 | Terminar y guardar la partida; resolver el aviso persistente; volver a iniciar 1P sin reconectar. La captura muestra 24 puntos con créditos y Cukie propios. | D12-1 · #418; aviso compartido con D12-3 | Primer parche local de reintentos del cierre y arranque 1P revisado por la raíz. Solicitadas regresiones monetarias de doble finish, fence, payload/identidad y errores permanentes, además de invalidar GAME_READY al recargar el mismo iframe. No aceptado ni desplegado todavía. |
...
| 12-M2 · Cukie Master 2 | Tras aprobar el NFT y cancelar el depósito, ofrecer Continuar depósito; conservar la elegibilidad y revalidar antes de firmar. | D12-2 · #419 · PR447 | Revisión raíz aceptada sobre `b882fe46`: conserva la aprobación, permite continuar y mantiene retirada ante aprobación residual. Una posición RPC desconocida bloquea la firma. 272 suites/2378 tests del candidato final correctos; despliegue staging pendiente. |
| 12-C2 · Créditos 2 | Finalizar el corte, mostrar créditos vigentes y permitir configurar el reparto siguiente con una fuente actual. | D12-3 · #421 | Primer parche local `3cd9a543`: admite varios runs legítimos por periodo/ruta y limita el aviso al servicio afectado. La tarea informa 59 pruebas focales, tipos y lint correctos; la raíz pide contraste causal y casos de agregación antes de aceptarlo. Sin despliegue nuevo. |
...
| 12-A1 · Embajadores 1 | El enlace activo `cw-876fe531558b` funciona estable en producción; distinguir indisponibilidad temporal de invitación inválida. | D12-4 · #424 · PR448 | Causa comprobada desde producción: el RPC singular devuelve403; otros tres RPC ya configurados responden200/chain56. El lector anterior ignoraba la lista. PR448 integrada en main `cf08e813` el 12-Sep a las 13:47 UTC; Coolify1554 en curso. Falta comprobar el enlace servido y propagar a staging. |
| 12-A3 · Embajadores 3 | Mostrar el alias público disponible encima de la wallet; fallback a dirección si no existe. | D12-4 · #424 · PR448 | Implementación revisada e integrada en main `cf08e813`: alias semanal elegido, después alias elegido de campaña runtime y username público exacto, con tiempos acotados. Consulta mínima de producción: la cuenta del ejemplo solo tiene alias automático y ningún username público; corresponde mostrar su wallet. Sin cambios de identidad. Despliegue y propagación pendientes. |
...
| 12-O2 · Otros 2 | Tras staking/retirada UKI o NFT confirmados, mostrar saldo, cupos, créditos y avisos coherentes sin recargar; comprobaciones adicionales en segundo plano. | D12-3 · #421 / #419 | En revisión técnica. Las pruebas preexistentes del provider y el parche de lectura de créditos no bastan para cerrar este punto: faltan las dos secuencias UKI/NFT del documento, incluidas respuestas fuera de orden. La tarea debe aportar esa evidencia o completar el parche. |

### Lotes de PR y propietarios

| Lote | Tarea | Rama y destino | Límites y entrega |
| --- | --- | --- | --- |
| D12-1 | **12-Sep · Partidas, ranking y premios**, tarea `01a095b4-c1c5-7591-979b-82bd2025c076` | `codex/doc12-game-settlement` → `staging` | Guardado/settlement, ranking, reserva y lectura de premios; contraste de O1 existente. #418 coordina y #423 recibe la evidencia de cierre. **En curso**, worktree `17f5`; primer diff revisado, solicitadas pruebas específicas de concurrencia y acreditación antes de aceptar. |
| D12-2 | **12-Sep · Continuar depósito en Master**, tarea `01a095b2-dbc0-7460-b97b-fcced4dea445` | `codex/doc12-master-resume` → `staging` | PR447. Código `b882fe46` aceptado tras corregir los dos hallazgos de revisión; validación final raíz 272 suites/2378 tests. En preparación de integración y despliegue. Worktree `c700`. |
| D12-3 | **12-Sep · Créditos y actualización de cupos**, tarea `01a095b3-7ec0-7280-8d5f-694bf44a18bc` | `codex/doc12-credit-coherence` → `staging` | Créditos/cortes y coordinación compartida de saldo, cupos y avisos. Dueño del refresco global; D12-1/2 consumen su contrato. **En curso**, worktree `54f6`. Primera revisión raíz de `3cd9a543` el 12-Sep a las 13:20 UTC; solicitados contraste causal y cobertura de O2. Aún no aceptado para integración. |
| D12-4 | **12-Sep · Hotfix de embajadores**, tarea `01a095b2-4772-7df0-afb8-db9254e56135` | `codex/doc12-ambassadors-hotfix` desde `main`, después propagación a `staging` | PR448 integrada en main `cf08e813`. Revisión raíz y 173 suites/1510 tests del candidato `7509735d` correctos. Coolify1554 en curso; falta verificación servida y propagación a staging. Worktree `2b5e`. |
