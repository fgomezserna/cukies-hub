...
| Cards/assets | **IMÁGENES AÚN SIN RECUPERAR LIVE**: 2026-09-08 21:08 UTC, Stage sirve `67303f6`; PR #336 abierta y worker legacy apagado. El token `4000000008733` del Marketplace devuelve URL AWS cuyo GET responde `403 application/xml`, por lo que aparece el logo de respaldo | [API del token visible](https://cukieshub.eurekand.com/api/legacy-marketplace/cukies?search=8733&limit=3), [PR #336](https://github.com/fgomezserna/cukies-hub/pull/336). Censo de referencia: 17.464 `cukies` legacy. Corrección acotada de guarda, conflictos de identidad, censo completo e IDs exactos en curso | Cerrar revisión/tests; comprobar destino Stage y carrera Mongo aislada; ejecutar publicación autorizada y verificar PNG real en Marketplace. No equiparar PR/merge con recuperación de imágenes ni activar importación masiva/indexador legacy |
