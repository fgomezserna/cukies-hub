...
| 4 | **HOTFIX VERIFICADO EN MAIN; PROMOCION A STAGING EN VALIDACION; PUBLICACION DE PRODUCTO PENDIENTE**: Cukie Master y sponsor confirmado para invitar, mismo codigo tras recuperar el rol, conservacion de referidos y correccion administrativa auditada. | Decision del usuario y [PR #351](https://github.com/fgomezserna/cukies-hub/pull/351); 2026-09-09: Main `4475baa`, Coolify `1464` terminado 14:09:27 UTC, health publico con SHA exacto. Migracion: 19 altas CW, 377 relaciones y 15 codigos anteriores intactos; replay 0. HMAC: sin firma 401, autorreferencia firmada 409. | Promover despues a staging sobre `ac521466` por CI de imagenes y verificar confirmacion gasless/administracion. Visibilidad de produccion sigue desactivada; no declara claims publicados ni activa porcentajes o niveles nuevos. |
...
### Estado vigente: hotfix verificado en MAIN, promocion a STAGING en validacion
