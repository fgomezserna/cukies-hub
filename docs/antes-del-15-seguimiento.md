...
- Filas **2A-C y 5**: el P2 de PR359 está corregido localmente (2026-09-09):
  ...
  conserva acceso UKI cuando la configuración exacta lo permite. Pendiente de nueva revisión.
...
- Lote de elegibilidad `MC09 / SV01–SV04 / V12`, 2026-09-09, sobre base
  ...
  **P2 corregido localmente; pendiente de nueva revisión del coordinador**.
  ...
  se libera el hueco para Datos/juego. Merge/deploy sujetos a nueva revisión y handoff INFRA.
