...
| D-stage | **RÉPLICA LEGACY EN STAGING · EN PREPARACIÓN**: reproducir un corte funcional y sanitizado de main en las bases aisladas de staging, junto a novedades97. Encargo exclusivo separado de la consolidación general. | Solicitud explícita del usuario12-Sep17:15–17:16UTC remitida desde la auditoría. Tarea **Réplica legacy de main en staging**, `01a096a5-848d-7292-af74-1e69300dc555`, Luna Max, worktree `a3e8`, rama `codex/stage-legacy-replica`, activa y con alcance confirmado. [Diagnóstico y límites de origen](legacy-marketplace/evidence/2026-09-12-production-source-audit.json). | Primera entrega: manifest por colección, identidad/corte/procedencia, exportación sanitizada y dry-run; revisión Astra antes de cargar/proyectar selectivamente en `cukies-legacy-staging` y `cukieshub-new-staging`. Preservar datos97/créditos/premios/auth y contratos; main solo lectura. Paridad, duplicados/huérfanos, idempotencia y QA de lecturas verificables antes del cierre. Raíz y auditora reciben hitos; seguimiento separado `coordinar-r-plica-legacy-staging`. No cambia escritores/tráfico/permisos ni reabre los diez puntos12-Sep. |
