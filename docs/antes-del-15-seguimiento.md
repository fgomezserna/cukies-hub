...
| 12-O2 · Otros 2 | Tras staking/retirada UKI o NFT confirmados, mostrar saldo, cupos, créditos y avisos coherentes sin recargar; comprobaciones adicionales en segundo plano. | D12-3 · #421 / #419 | **PR453: código revisado y checks correctos; merge/despliegue pendientes.** `15067005` conserva el acuse por operación y reanuda lectura tras reset de identidad. La regresión97→56→97 ya exige Credits1/pendiente0 y ausencia de nuevas lecturas tras render estable;64 focales correctas. Raíz revisó el cierre mínimo e integró en `92983598`:275 suites/2418 tests, tipos y lint correctos. La incorporación posterior de staging solo modifica documentación. Sin merge/deploy todavía. Conserva gracia y créditos ganados. |
...
| D12-3 | **12-Sep · Créditos y actualización de cupos**, tarea `01a095b3-7ec0-7280-8d5f-694bf44a18bc` | `codex/doc12-credit-coherence` → `staging` | PR450 y PR452 desplegadas: C2 operativo. O2 en PR453, rama `codex/o2-readback-coherence`, worktree `54f6`. `15067005` entregado y cierre mínimo revisado por raíz; la regresión ya termina el readback después del reset sin bucles. Integración `92983598` con275 suites/2418 tests, tipos y lint correctos; revisión cerrada por raíz. Pendiente merge/despliegue. |
