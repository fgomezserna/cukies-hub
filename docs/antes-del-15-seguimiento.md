...
| D-stage | **UNIFICAR TODAS LAS BASES EN UNA DE STAGING · MAPEO EN CURSO**: Hub/auth, legacy e indexer/economía deben compartir una única base y sus servicios deben usarla. Aclaración explícita del usuario12-Sep: staging es un entorno de pruebas; no requiere conservar ni recuperar sus datos actuales. El enfoque anterior de réplica manteniendo tres bases queda supersedido. | Misma tarea **Unificar las bases de datos en staging**, `01a096a5-848d-7292-af74-1e69300dc555`, Luna Max, worktree `a3e8`. [PR454](https://github.com/fgomezserna/cukies-hub/pull/454) conserva el candidato anterior `c41995ea` como trabajo sin aplicar; sus reparaciones no son un prerrequisito automático de la unificación. [Evidencia, alcance anterior y aclaración](legacy-marketplace/evidence/2026-09-12-production-source-audit.json). No hay exportación, carga ni cambio de destinos remoto. | Preparar mapeo concreto de colecciones/índices/origen y servicios/variables/guards hacia una única base, reutilizando la auditoría disponible. Consultar al usuario los conflictos reales y la resolución propuesta antes de decidirlos; no ampliar el framework de réplica anterior. Producción solo lectura e intacta. Coordinación automática PAUSED hasta acordar cómo continuar. Los diez puntos12-Sep mantienen su cierre técnico; esta unificación es otro alcance. |
