...
- Filas **2A-C y 5**: el defecto del CTA `Vender` que excluía BSC97 y ligaba
  la venta BSC56 a V2 está corregido localmente en `codex/seller-eligibility-v2`
  (2026-09-09); su integración y aceptación live siguen pendientes. El contrato V2 cubre precio/cobro UKI,
...
- Lote de elegibilidad `MC09 / SV01–SV04 / V12`, 2026-09-09, sobre base
  `1646602`, rama `codex/seller-eligibility-v2`: parche local validado, pendiente
  de revisión independiente e integración. «Vender» resuelve cadena y colección exactas,
  exige propiedad y disponibilidad en wallet, y dirige al flujo Legacy o UKI
  correspondiente. La selección UKI conserva la identidad del Cukie solicitado.
  ...
  Gates finales: `pnpm dapp lint` sin avisos y `pnpm dapp test --runInBand`
