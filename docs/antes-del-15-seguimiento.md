...
| post1-2 | **ANTES DEL 15 · RUTAS Y LECTURAS PARCIALES PUBLICADAS**: Crías y Cukie Points aparecen en la navegación compartida; las escrituras permanecen cerradas. | 2026-09-10: código PR358 integrado en366 y conservado en Stage `11de87e4`. Points BSC muestra total1.205.934, emitidos1.358.198 y quemados152.264. El diagnóstico atribuye TRON429 a cuatro constantes simultáneas contra el límite anónimo de TronGrid; Promise.all descarta éxitos parciales. Crías bloquea candidatos por wallet97, aunque la cabecera0/1 se lee de BSC56 y coincide con consulta directa. [Evidencia del lote y diagnóstico](evidence/2026-09-10-seller-legacy-integration.json). | Responsable Legacy `01a08727-0cdb-7993-bbab-6829bcf3d333` entregó `17cff24` y corrección `12140c4`; raíz revisó R1/R2 resueltos. Integrado localmente sobre Stage0cf0019 en `babb053`: seis archivos exactos al candidato, proveedorTRON de lectura/parciales y consultaBSC56 independiente de wallet97, Actualizar/preview/candidatos y textos corregidos. Gates finales239suites/1.931tests, lint/tipos/build92 PASS. Pendiente de entrega y QA visible; escrituras cerradas. [Revisión y validación](evidence/2026-09-10-legacy-readonly-qa.json). Sin push/deploy concurrente ni cambios de infraestructura. Reconciliar claimed/pending, eventos y cursores e identificar Bread por address/bytecode/ABI; este lote no cierra paridad ni operaciones. |
...
conserva propiedad exclusiva de los archivos compartidos. PR369 ya entregó el
parche de bloqueo de créditos en0cf0019; la corrección Legacy de lectura está
validada para otra entrega DApp-only. World reconciliará la base vigente antes
de publicarse, preservando esos cambios y los200archivos del port. Los lotes358/359 no sustituyen el
