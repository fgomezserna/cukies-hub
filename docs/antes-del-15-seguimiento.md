...
| D | **MIGRACION LEGACY Y WORLD POR COMPLETAR; DOS LOTES COORDINADOS**: conservar el port World y migrar contratos, datos, identidad y consumidores legacy sobre la infraestructura nueva. Learn/Ludo, auth/GraphQL y operacion Unreal/Agones siguen en el alcance total. | 2026-09-10: [PR346](https://github.com/fgomezserna/cukies-hub/pull/346), `f4cae5e307fed2a84acf0de3e33d0dae9b25b0a1`, worktree limpio y sin commits posteriores; DRAFT/CONFLICTING, sin integrar ni desplegar. Traslada world-api/matchmaking/shared con procedencia del origen, 137 tests World y 40 de infraestructura historicos. [PR358](https://github.com/fgomezserna/cukies-hub/pull/358), `1542c25`, revisada y ready para navegacion/lecturas blockchain Legacy; no acredita paridad completa. | World: tarea `01a085a9-ce55-75e0-831e-b356608c2ab9`, Identifica los dos proyectos; conservar paquetes, infrastructure/world, lock/importers y procedencia historica sin rehacerla desde un origen distinto. Blockchain Legacy: `01a08727-0cdb-7993-bbab-6829bcf3d333`. INFRA posee la edicion de CI/Compose/Docker/Nx/workspaces/lock/manifiestos y acuerda una unica ventana de adaptacion346 tras PR364; registrar imagenes World, Redis de infraestructura e invalidacion shared hacia ambas imagenes. Reconciliar datos/IDs, emisor Hub→World, cliente y unico escritor antes de activar; cero consumidores antes de retirar servicios antiguos. |
| 1 | **CODIGO Y NAVEGACION PUBLICADOS · ENTREGA DE CONFIGURACION BRIDGE PENDIENTE**: PR358 está integrada en el lote366; la ruta abre, pero el build conserva `NEXT_PUBLIC_CUKIES_BRIDGE_MODE=disabled`. | 2026-09-10: Stage `f2818618`, CI34419415547 y health/ready200; la QA confirma Bridge no disponible. [Evidencia del lote](evidence/2026-09-10-seller-legacy-integration.json). | Responsable Legacy `01a08727-0cdb-7993-bbab-6829bcf3d333`; INFRA configuró únicamente `legacy-readonly` en el build público de staging a00:22:49UTC, roundtrip hash`b9a493e1…` PASS, BSC56/TRON mainnet y operationsEnabled=false. Requiere siguiente entrega coordinada y verificación servida de raíz. RPC archive/#321, custodia, relayer, fee/pausa y E2E siguen pendientes antes de activar operaciones. No acredita paridad completa ni cambia producción. |
...
| post1-2 | **ANTES DEL 15 · RUTAS Y LECTURAS PARCIALES PUBLICADAS**: Crías y Cukie Points aparecen en la navegación compartida; las escrituras permanecen cerradas. | 2026-09-10: PR358 integrada en366, Stage `f2818618`. Points BSC muestra total1.205.934, emitidos1.358.198 y quemados152.264; TRON queda sin saldo verificado y aparece429. Crías bloquea la consulta por walletBSC97 y muestra cabecera0/1 sin lectura validada. [Evidencia del lote](evidence/2026-09-10-seller-legacy-integration.json). | Responsable Legacy `01a08727-0cdb-7993-bbab-6829bcf3d333` diagnostica la fuente exacta del429 y el estado desconocido, y propone lectura BSC56 separada de la red de firma. Reconciliar claimed/pending, eventos y cursores e identificar Bread por address/bytecode/ABI; este lote no cierra paridad ni operaciones. |
...
INFRA completó la base CI364/365 y liberó la ventana. La raíz integra primero
el lote conjunto358/359 como PR366 `f2818618`; las dos ramas originales se conservan.
Antes de la siguiente ventana se completa el ajuste de Bridge a solo lectura;
los hallazgos de lecturas parciales quedan en las filas1/post1-2, con dueño Legacy.
La adaptación de PR346 sigue después, en una sola ventana, con World como
propietario del port e INFRA de los archivos de infraestructura compartidos. Los lotes358/359 no sustituyen el
