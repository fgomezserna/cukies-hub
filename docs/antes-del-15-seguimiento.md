...
| post1-2 | **ANTES DEL 15 · INTEGRACION PREPARADA DE LECTURAS LEGACY**: Cukie Points y Crías usan las identidades Legacy existentes desde Stage; las escrituras permanecen cerradas. | 2026-09-10: PR358 `1542c25` en el lote combinado con Vender, candidato `a2fc72e`. [Evidencia del lote](evidence/2026-09-10-seller-legacy-integration.json). | Responsable Legacy `01a08727-0cdb-7993-bbab-6829bcf3d333`; publicar y comprobar las rutas servidas. Reconciliar claimed/pending, eventos y cursores BSC/TRON e identificar Bread por address/bytecode/ABI. Permanecen dentro de la migración anterior al 15; navegación y lecturas no cierran las operaciones pendientes. |
...
el lote conjunto358/359 sobre `d1403a5`; las dos ramas originales se conservan.
