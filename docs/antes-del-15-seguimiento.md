...
| post1-2 | **ANTES DEL 15 · MIGRACION LEGACY**: Cukie Points y crias siguen ligados al bloque de migracion; no son activos POST-15. | Decision de producto; 2026-09-07. | Responsable Legacy `01a08727-0cdb-7993-bbab-6829bcf3d333`: PR358 de Crías/Points revisada y ready, pendiente de deploy; aclaracion contractual Bread, sin confundirlos ni declarar paridad por HTTP 200. Inventario y migracion validada; no ejecutar pausa/corte en este seguimiento. |
...
INFRA termina primero la base CI de PR364. La adaptacion de PR346 se hace despues
sobre esa base y una sola vez, con World como propietario del port e INFRA de
los archivos de infraestructura compartidos. Los lotes358/359 no sustituyen el
