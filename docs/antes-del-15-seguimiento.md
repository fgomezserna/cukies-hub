...
| Cards/assets | **REGENERACIÓN COMPLETA; CIERRE DE OPERACIÓN PERMANENTE EN CURSO**: 2026-09-09 03:20 UTC, Stage sirve `e3d05a6` (PR #336). Indexed **18/18** = 16 generadas + 2 válidas; legacy **17.464/17.464** = 17.462 generadas + 2 válidas; ambos `complete`, delta 0, fallos 0 y PNG temporal pendiente 0. Mongo/URL/jobs verificados concuerdan para los 17.482 IDs; 37 GET públicos por red/generación/rareza pasan hash, longitud y MIME. Mis Cukies 12/12 y Master 6/6 cargan imágenes reales | [Catálogo #8733](https://cukieshub.eurekand.com/api/marketplace/v1/catalog?scope=legacy&search=8733&limit=4), [PR #336](https://github.com/fgomezserna/cukies-hub/pull/336). VM1001 `/srv/cukies-card-publish-20260908/reconciliation-final.json`, manifiestos `backfill-indexed.json`/`backfill-legacy.json` y resultado `cukies-card-publish-runtime-20260909025419952.json` (fin 02:54:19.942 UTC, 17.462 uploads verificados = 17.462 PNG retirados, cleanupErrors vacío). Legacy: BSC 4.405/TRON 13.059, generaciones 12.100/5.364, 10.728 referencias de padres y 10.728 de hijos resueltas sin huérfanos; 24.200 posiciones de padres vacías, no errores. Suelos guardados de 10 GiB; capacidad final MinIO 12,927 GB y VM 23,569 GB | Pendiente publicar hidratación batch de relaciones (el hijo `4000000015494` ya tiene PNG propio, pero el catálogo aún emite fallback AWS), verificar ambos daemons permanentes con limpieza post-Mongo/guardas de capacidad y cerrar custodia temporal. El 404 de `/marketplace/4000000008733`, demostrado por clic real, es un defecto de navegación separado; no atribuirlo al backfill. No importar legacy a fixtures 97 ni activar indexador legacy/economía; main/app12/remotion intactos |
