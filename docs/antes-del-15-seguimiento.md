...
Ultima actualizacion: 2026-09-10; horas de evidencia indicadas en UTC.
...
| --- | --- | --- | --- |
| INFRA | **REGISTRY ACTIVO EN STAGE: WEB, JUEGO Y WORKERS**: web32 sirve `4a08053`, Treasure Hunt31 conserva `11de87e4` / config `b9a493e1…`; workers28 conservan `dc4c21e`; Mongo LXC2007, builder VM1012 (12 GiB/BuildKit 9 GiB) y registry VM1007. Coolify descarga imágenes; Git autodeploy OFF. | 2026-09-09 23:20 UTC: [evidencia de entrega](../infrastructure/ci/2026-09-09-rolling-delivery-evidence.json). CI34412775416 construyó seis imágenes; el bootstrap del juego falló por `COOLIFY_BRANCH` ausente y se recuperó explícitamente, conservando el juego anterior hasta readiness. Candidato fallido, rollback web entre imágenes con cierre gradual, vuelta a `dc4c21e` y reemplazo aislado del juego: **1472/1472 HTTP200** entre origen y público. Web/workers y producción conservaron IDs/digests en game-only. Juego 4,31 GB → 510 MB; 551 archivos públicos y 12 JS/CSS comprobados. Indexador: cinco ciclos completos, bloques 130109312→130109562. Journals reconciliados. | PR365 `d1403a5`, CI34416957133 SUCCESS: build vacío, seis imágenes reutilizadas y entrega omitida; 15 IDs/imágenes Stage/Prod y estado durable conservados a las23:28:43UTC. Lote359/358 integrado en PR366 `f2818618`, CI34419415547 SUCCESS: DApp reconstruida, otras cinco imágenes reutilizadas y 14 contenedores protegidos conservados. [Evidencia](evidence/2026-09-10-seller-legacy-integration.json). PR367 `11de87e4`, CI34421399357 SUCCESS: Bridge `legacy-readonly` servido y verificado; se reconstruyeron DApp y juego por el hash público compartido, con cuatro imágenes workers reutilizadas. Postflight00:39UTC: 13 contenedores workers/producción conservados, journal limpio y guards PASS; cuatro endpoints públicos200. La raíz verificó la vista Bridge y Aprobar/Iniciar deshabilitados. PR369/370 publicaron créditos y lecturas Legacy; PR371 `9d3e728`, CI34430206966 SUCCESS, reutilizó seis imágenes y omitió la entrega. Adaptación World `09401296` reconciliada con ese staging en `73dc4db`: ocho componentes, World fuera del Compose servido, sin activar runtime/escrituras. Gates locales: 125 tests CI, paquetes World, imágenes linux/amd64 y smoke Mongo/Redis sintéticos PASS. P2-01 corregido en `a9ee0e8` e integrado en `cfeab56`: un estado antiguo sin identidades servidas verificadas se bloquea antes de persistir;126 checks CI PASS, revisión raíz conforme. [Evidencia del candidato](evidence/2026-09-10-world-ci-integration.json). PR372 integrada en `25284f9`, CI de PR34432440415 SUCCESS. Publicación34432744474 construyó las dos imágenes, pero el smoke falló por un `.trim()` sobre stdout nulo tras descargar; bootstrap/persistencia/entrega omitidos. Parche `329a011`+`207096d` revisado: stdout heredado y entrada CLI canónica,132 checks CI y prueba real pull/OCI/harness sobre los digests25284f9 PASS. PR373 `556ee51` integró el parche, CI de PR34433901353 SUCCESS. Publicación34434107532 cancelada por raíz antes de build/entrega: el nuevo test World no estaba clasificado y produjo build8/reuse0. Clasificación exacta corregida en `70fa033`+`82bf206`,133 checks CI PASS: wrapper+test World2/reuse6, test-only0/reuse8, CI desconocido conservador. Se exige sonda raíz del HEAD final con state y Nx observados antes de merge; un único propietario INFRA edita CI/Compose/Nx/lock. Main/app12/app13 siguen en su ruta actual; PR361 draft `72ba26a`, app33 sin arrancar, CI prod false. Práctica anónima bloqueada por un guard funcional anterior; no se afirma QA de partida autenticada ni autoscalado. |
...
| D | **MIGRACION LEGACY Y WORLD POR COMPLETAR; PORT INTEGRADO, REGISTRO WORLD PENDIENTE**: trasladar contratos, datos, identidad y consumidores legacy a la infraestructura nueva. Learn/Ludo, auth/GraphQL y operación Unreal/Agones siguen en el alcance total. | 2026-09-10: [PR346](https://github.com/fgomezserna/cukies-hub/pull/346), origen `f4cae5e307fed2a84acf0de3e33d0dae9b25b0a1`, rama y worktree originales limpios e intactos. 205 deltas inventariados; 200 archivos importados, de los que 199 mantienen blob/modo exacto y uno es el README adaptado al CI. Procedencia y evidencia histórica conservan sus hashes. Candidato INFRA `09401296`, base producto `4a08053`, reconciliado con staging `9d3e728` sin conflictos e integrado mediante [PR372](https://github.com/fgomezserna/cukies-hub/pull/372), `25284f9`. [Evidencia](evidence/2026-09-10-world-ci-integration.json). PR358 integrada mediante366 y lecturas mejoradas mediante370 no acreditan paridad completa. | INFRA `01a0859a-cf4d-77a0-a137-6db60a0a0f96` posee CI/Compose/Docker/Nx/lock; raíz revisa e integra el candidato separado, con P2-01 corregido y sin sobrescribir PR346 ni el checkout `codex/legacy-migration-inventory`. World `01a085a9-ce55-75e0-831e-b356608c2ab9` conserva su port; Legacy blockchain `01a08727-0cdb-7993-bbab-6829bcf3d333` mantiene su lote independiente. Registrar/publicar imágenes no activa World: reconciliar datos/IDs, emisor Hub→World, cliente y un único escritor antes del cambio de tráfico; cero consumidores antes de retirar servicios antiguos. |
...
| 3 | **EN STAGING, EN PRUEBAS · BLOQUEO NFT RECUPERADO Y LECTURAS COHERENTES**: Cukie Master, creditos, pools, prestamos y rewards. | 2026-09-09, PR362 y Stage `bdab82c`: Transfer #98000007 proyectado a las 21:45:11 en intento6; dead-letter0 y tx_nfts1 verificados a las 21:47. Fuentes UKI/NFT frescas despues de22:01, dos ticks Master sin ownership aplazado y corte22:00 procesado22:01:17 sin pendientes. QA autenticada22:08:59:3NFT/0UKI,300creditos =200jugar+100pool. Reconciliacion22:18 de134 asientos/33items/33lotes: sin claves duplicadas, referencias ausentes ni diferencias. [Evidencia de cierre](evidence/2026-09-09-nft-recovery-close.json). Los5400historicos corresponden a3000grants+2400compensacion, expiradosel7/9; no permiten atribuir la captura sinwallet/periodo exactos. [RCA y evidencia anterior](evidence/2026-09-09-master-credit-coherence.json). | Responsable datos/juego `01a0814e-0ea0-7070-877c-701f264243e7`, Astra Max con ejecucion Luna Max. Recuperacion limitada al evento bloqueado y lecturas actuales; no se escribieron manualmente saldos/cupos/cursores/watermarks. El agregado bruto pool_deposit200 incluye ambos lados contables: aporte real100. Continuar las pruebas amplias de economia/UX de #289 y el recorrido de juego; conservar cierre historico #326 y avisos independientes de Vesting. Produccion `4475baa` sin cambios en esta recuperacion. |
...
| post1-2 | **ANTES DEL 15 · LECTURAS PUBLICADAS Y VERIFICADAS · IDENTIDAD DE PADRES ABIERTA**: Crías y Cukie Points están en la navegación; las escrituras siguen cerradas. | 2026-09-10: [PR #370](https://github.com/fgomezserna/cukies-hub/pull/370), Stage `4a08053`, CI34428987963SUCCESS, solo DApp/reuse5 y contenedores de juego/workers/producción preservados. Gates finales239suites/1.931tests, lint/tipos/build92 PASS. QA visible: Crías lecturaBSC verificada con0puntos/máximo1 y Actualizar operativo sin cambiar red; Points BSC total1.205.934 y TRON5.024.269 verificados, con emitidos/quemados disponibles. [Evidencia y límites](evidence/2026-09-10-legacy-readonly-qa.json). | Responsable Legacy `01a08727-0cdb-7993-bbab-6829bcf3d333`; fuente12140c4 preservada, R1/R2 resueltos. Nuevo hallazgo confirmado `LEGACY-BREEDING-IDENTITY`: endpoint filtra BSC sin chainId/colección; devuelve12NFT de97 y6sin identidad para contratos56. Próximo lote acotado debe validar identidad mainnet y elegibilidad/propiedad actual en servidor y preview, sin mutar fixtures ni activar firmas. Espera plaza libre tras WorldCI/Datos; no repetir gates de370. Reconciliar historial/events/cursores e identificar Bread por address/bytecode/ABI; no se cierra paridad ni operaciones. |
...
El candidato inicial World `1661ecaa` inventarió 205 deltas e importó 200 archivos
exactos del origen. INFRA añadió la capa común en `09401296`, conservando ese
port y 4224 entradas previas del lock. La raíz reconcilió staging `9d3e728` en
`73dc4db`, sin conflictos ni cambios de DApp/juego; adapta únicamente el README
World y marca el traspaso inicial como histórico. 199 archivos originales siguen
exactos; la procedencia histórica permanece intacta. La revisión independiente
detectó P2-01 en estados antiguos ambiguos. La corrección `a9ee0e8`, integrada
en `cfeab56`, exige las identidades servidas y bloquea antes de persistir:126
checks CI PASS y revisión raíz conforme. PR372 se integró en `25284f9`, con
CI de PR completo correcto. La publicación34432744474 construyó las imágenes,
pero el wrapper falló tras el pull por tratar stdout heredado nulo como texto.
El gate omitió entrega y registro. INFRA corrigió stdout y detección de
entrada CLI en `329a011`+`207096d`:132 checks CI PASS y pull/OCI/harness real
sobre ambas imágenes25284f9 PASS. Raíz revisó el diff y conserva el fallo
inicial como evidencia. PR373 `556ee51` integró el parche, con CI de PR correcto. La raíz canceló
publicación34434107532 antes de build/entrega porque el test nuevo provocó
build8/reuse0. INFRA corrigió su clasificación explícita en `70fa033`+`82bf206`:133
checks CI PASS, con regresión también para cambios posteriores al registro.
La raíz comprobará el HEAD final con el state y Nx observados antes de merge;
el registro World permanece pendiente; véanse las filas D e
INFRA y su evidencia. Los lotes 358/359 no sustituyen el port World.
