...
| 12-O2 · Otros 2 | Tras staking/retirada UKI o NFT confirmados, mostrar saldo, cupos, créditos y avisos coherentes sin recargar; comprobaciones adicionales en segundo plano. | D12-3 · #421 / #419 | **En corrección técnica, PR453 draft.** Candidato `ad13fba0`: raíz pasó275 suites/2417 tests, tipos y lint, pero la revisión independiente reprodujo otro fallo al cambiar97→56→97: `idle`, pendiente borrada y Master1/Credits0. Un reset de identidad se confundía con readback completado. La misma tarea debe acreditar explícitamente la publicación del par por operación; sin merge/deploy hasta corregir y probar esa carrera. El problema de expectativas sustituidas/terminales sí quedó resuelto. Evidencia12-Sep16:26UTC; conserva gracia y créditos ganados. |
...
| D12-3 | **12-Sep · Créditos y actualización de cupos**, tarea `01a095b3-7ec0-7280-8d5f-694bf44a18bc` | `codex/doc12-credit-coherence` → `staging` | PR450 y PR452 desplegadas: C2 operativo. O2 permanece en PR453, rama `codex/o2-readback-coherence`, worktree `54f6`. Tras275 suites/2417 tests, Astra reprodujo pérdida prematura de la pendiente al cambiar97→56→97 con Credits antiguo. Tarea reactivada para sustituir la inferencia `idle`/generación por prueba de publicación conjunta por operación y añadir regresión. Raíz conserva revisión, integración y despliegue. |
