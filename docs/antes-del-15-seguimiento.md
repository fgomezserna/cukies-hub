...
| 12-A3 · Embajadores 3 | Mostrar el alias público disponible encima de la wallet; fallback a dirección si no existe. | D12-4 · #424 | La API del enlace devuelve `ambassadorPublicName:null`; eso no demuestra ausencia de alias de juego. La raíz solicita contrastar la lectura canónica por vínculo exacto. #422 conserva la escritura del perfil; no excluye esta lectura. Sigue abierto, sin invención ni asociación de identidades desde rankings anónimos. |
