...
- L2 y L5 han terminado sus correcciones;432y433ya están servidas.
  ...
  L4 corrige el P1 de PR434 detectado por revisión Astra independiente:
  preparador/publisher deben validar el periodo canónico incluso si el artefacto
