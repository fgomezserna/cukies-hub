...
| Cards/assets | Integración local lista: identidad canónica, delta, fencing y guard de staging; worker apagado | No ejecutar cards/backfill: pendiente censo por red/colección/origen, capacidad/backup y carrera Mongo aislada | Tras gates operativos: PR revisada, dry-run contextual, conciliación y smoke de card worker |
