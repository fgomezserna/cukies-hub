...
const SOUND_CONFIG: Record<SoundType, { 
  ...
  bug_collision: { path: '/assets/sounds/Sonidos/Golpe Recibido/Golpe 2.wav', volume: 0.8, category: 'effect' },
  ...
  game_start: { path: '/assets/sounds/Sonidos/ZZZ RETRO EVENT/Retro Event UI 01.wav', volume: 0.6, category: 'ui' },
  pause: { path: '/assets/sounds/Sonidos/Boton Pause/Pause 1.wav', volume: 0.5, category: 'ui' },
  resume: { path: '/assets/sounds/ui/button-click-01.mp3', volume: 0.5, category: 'ui' },
  
  // Voice
  jeff_goit: { path: '/assets/sounds/Sonidos/Goat/Goat 0.mp3', volume: 0.8, category: 'voice' },
  whale_chad: { path: '/assets/sounds/Sonidos/Haku/Haku 1.wav', volume: 0.8, category: 'voice' },
  ...
  frenzy_mode: { path: '/assets/sounds/Sonidos/Musica/retro-wave-style-track-59892.mp3', volume: 0.4, loop: true, category: 'music' },
