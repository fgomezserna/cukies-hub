...
const SERVICE_IMAGES = Object.freeze({
  ...
  'cukie-pool-scheduler': 'CUKIES_IMAGE_DAPP',
  'weekly-ranking-scheduler': 'CUKIES_IMAGE_DAPP',
  'reward-accounting-scheduler': 'CUKIES_IMAGE_DAPP',
  'reward-batch-publisher': 'CUKIES_IMAGE_DAPP',
});
...
async function main() {
  ...
  if (currentImages !== null && currentImages !== generatedImages) {
